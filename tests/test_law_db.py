...
class TestLoadExistingIndexEntries:
    ...
    def test_preserves_entries(self, tmp_path):
        ...
        searches, documents, fulltexts, guidelines, web = law_db.load_existing_index_entries(
            tmp_path / "index.json"
        )
...
class TestCollectIndexData:
    def test_empty_archive(self, tmp_path):
        law_db.ensure_law_db_structure(tmp_path)
        searches, documents, fulltexts, guidelines, web = law_db.collect_index_data(tmp_path)
        assert searches == []
        assert documents == []
        assert fulltexts == []
        assert guidelines == []
