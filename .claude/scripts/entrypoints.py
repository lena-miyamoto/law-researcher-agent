...
def law_db():
    return _load_script("law_db", "law-db.py").main()


def law_db_lookup():
    return _load_script("law_db_lookup", "law-db-lookup.py").main()


def law_db_query():
    return _load_script("law_db_query", "law-db-query.py").main()


def law_db_integrity_check():
